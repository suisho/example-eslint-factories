...
},{"./normalize":5,"insert-css":4}],4:[function(require,module,exports){
var inserted = [];
...
},{"./Cancellation":6,"./History":7,"./Match":8,"./PathUtils":10,"./PropTypes":11,"./Redirect":12,"./Route":13,"./ScrollHistory":14,"./Transition":16,"./actions/LocationActions":17,"./behaviors/ImitateBrowserBehavior":18,"./createRoutesFromReactChildren":28,"./isReactChildren":31,"./locations/HashLocation":32,"./locations/HistoryLocation":33,"./locations/RefreshLocation":34,"./locations/StaticLocation":35,"./supportsHistory":38,"_process":1,"react":199,"react/lib/ExecutionEnvironment":64,"react/lib/invariant":179,"react/lib/warning":198}],28:[function(require,module,exports){
/* jshint -W084 */
'use strict';
...
},{"react":199,"react-router":30}],201:[function(require,module,exports){
"use strict";
...
var Question1 = (function (_React$Component) {
  function Question1() {
    _classCallCheck(this, Question1);
  ...
  _inherits(Question1, _React$Component);

  _createClass(Question1, [{
    key: "render",
    value: function render() {
      return _react2["default"].createElement(
        "div",
        { className: "page page-question" },
...
var _componentsStartJsx = require("./components/Start.jsx");

var _componentsStartJsx2 = _interopRequireDefault(_componentsStartJsx);

var _componentsQuestionJsx = require("./components/Question.jsx");

var _componentsTimelineJsx = require("./components/Timeline.jsx");

var routes = _react2["default"].createElement(
  _reactRouter.Route,
  { name: "app", path: "/", handler: _componentsAppJsx2["default"] },
  _react2["default"].createElement(_reactRouter.Route, { path: "/", handler: _componentsStartJsx2["default"] }),
  _react2["default"].createElement(_reactRouter.Route, { path: "/question/1", handler: _componentsQuestionJsx.Question1 }),
  _react2["default"].createElement(_reactRouter.Route, { path: "/timeline", handler: _componentsTimelineJsx.Timeline }),
  _react2["default"].createElement(_reactRouter.DefaultRoute, { handler: _componentsStartJsx2["default"] })
);

function render(container) {
  _reactRouter2["default"].run(routes, function (Root) {
    _react2["default"].render(_react2["default"].createElement(Root, null), container);
  });
}

module.exports = exports["default"];

},{"./components/App.jsx":200,"./components/Question.jsx":201,"./components/Start.jsx":202,"./components/Timeline.jsx":203,"react":199,"react-router":30}],205:[function(require,module,exports){
module.exports = "body{background:#333;box-sizing:border-box;color:#ccc}a{color:#ccc;-webkit-tap-highlight-color:rgba(0,0,0,0)}.page{padding:1em}.page-start .logo{font-size:48px;color:#ccc;text-align:center}.page-start .start-button-container{width:100%;}.page-start .start-button-container a{text-decoration:none}.page-start .start-button{vertical-align:middle;text-align:center;line-height:1.8em;font-size:96px;font-weight:bold;width:192px;height:192px;border-radius:96px;background:#e1d16a;margin:0 auto;margin-top:100px;}.page-start .start-button a{color:#333}.page-start .skip{display:block;position:fixed;bottom:1em;margin:0 auto;text-align:center;padding-top:300px;width:100%;height:20px;z-index:-1}.page-question .osumes{font-size:76px;text-align:center;}.page-question .osumes .osu,.page-question .osumes .mesu{margin:10px;padding:10px;border-radius:96px}.page-question .osumes .osu{background:#6e60d8}.page-question .osumes .mesu{background:#d88ccf}"
...
(0, _routerJsx2["default"])(container);

(0, _insertCss2["default"])(require("normalize-css"));
(0, _insertCss2["default"])(require("./style/main.styl"));

},{"./components/App.jsx":200,"./router.jsx":204,"./style/main.styl":205,"insert-css":2,"normalize-css":3,"react":199}]},{},[206]);
